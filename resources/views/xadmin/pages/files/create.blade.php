...
<div class="bg-white p-4 rounded-lg shadow-md w-full lg:max-w-3xl mx-auto">
        ...
        <form action="{{ route('filesCreatePost') }}" method="post"  enctype="multipart/form-data">
            @csrf
            ...
            <div class="mx-auto max-w-[600px]">
                <div class="form-group mb-3">
                    ...
                    <div class="mt-2">
                        <input id="title" name="title" type="text" required class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="mt-2">
                        <input id="image" name="image" accept=".pdf"  type="file" class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
