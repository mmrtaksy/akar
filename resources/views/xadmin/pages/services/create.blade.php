...
@section('content')
    ...
    <form action="{{ route('servicesCreatePost') }}" method="post">
        @csrf
                    ...
                    <div class="p-3 relative ">
                        <div class="flex flex-wrap justify-between">
                            <div class="mb-3 relative">
                                <h3 class="text-lg font-semibold">{{ $panelMenu['title'] }} - Yeni Kayıt Oluştur</h3>
                                                ...
                                                <select id="parent_id" name="parent_id"
                                                    ...
                                                    @if ($parents)
                                                        ...
                                                        @foreach ($parents as $item)
                                                            @if (isset($parentid) && $parentid == $item->id)
                                ...
                                <div class="mt-2">
                                    @if ($panelMenu['editor'])
                                        <textarea id="description" rows="6" name="description" required
                                            class="content px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ old('description') ? old('description') : '.' }}</textarea>
                                    @else
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="mt-2">
                                                        <input id="{{ $field['name'] }}"
                                                            ...
                                                            type="text"
                                                            value="{{ old('extra.' . $loop->index . '.' . $field['name']) ?? $modelId == 2 ? 'Evet' : '' }}"
                                                            class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                    </div>
                                                </div>
                                            @endforeach
                ...
                <div class="col-span-12 md:col-span-3">
                    ...
                    @if ($panelMenu['meta'])
                        <div class="bg-white p-4 rounded-lg shadow-md relative">
                            <div class="mb-3 relative">
                                <h3 class="text-lg font-semibold">SEO Yönetimi</h3>
                            ...
                            <div class="form-group mb-3 col-span-2">
                                ...
                                <div class="my-2">
                                    <input id="slug" name="slug" type="text" value="{{ old('seo_title') }}"
                                        class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                                <label for="meta_title" class="block text-sm font-medium leading-6 text-gray-900">Meta
                                    Title</label>
                                <div class="my-2">
                                    <input id="meta_title" name="meta_title" type="text" value="{{ old('seo_title') }}"
                                        class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>

                                <label for="meta_description" class="block text-sm font-medium leading-6 text-gray-900">Meta
                                    Description</label>
                                <div class="my-2">
                    ...
                    @if ($panelMenu['image'])
                        <div class="bg-white p-4 rounded-lg shadow-md relative {{ $panelMenu['meta'] ? 'mt-4' : '' }}">
                            <div class="form-group mb-3 col-span-2">
                                <label for="images" class="block text-sm font-medium leading-6 text-gray-900">Seçilen
                                    Resimler</label>
                                <div class="mt-2 flex flex-wrap gap-2 adderImages"></div>
                            </div>
                        </div>
                    @endif
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.remove_image', function(e) {
                e.preventDefault();
                $(this).closest('.static-image-item').remove();
                return false;
            });
