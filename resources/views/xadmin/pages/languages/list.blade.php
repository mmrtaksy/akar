...
@endphp
    ...
    <div class="bg-white p-4 rounded-lg shadow-md w-full lg:max-w-6xl mx-auto">
        ...
        <div class="mb-3 relative flex items-center justify-between">
            <h3 class="text-lg font-semibold">Dil Yönetimi</h3>
            <a class="text-md text-blue-600 font-medium mt-5 inline-block" href="{{ route('languagesCreateGet') }}">Yeni bir tane ekle</a>
        </div>
          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400" id="tableList">
            <thead class="text-xs text-gray-700 uppercase bg-gray-200">
                <tr>
                    ...
                    <th class="px-4 py-2 border border-gray-300">Dil</th>
                    <th class="px-4 py-2 border border-gray-300">Native</th>
                    <th class="px-4 py-2 border border-gray-300">Ana Dil</th>
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td class="{{ $tdClass}}">{{ $item->native }}</td>
                      <td class="{{ $tdClass}}">{{ $item->is_default }}</td>
                      ...
                      <td class="{{ $tdClass}} text-center">
                        <div class="flex items-center gap-1 p-3">
                          <a href="{{ route('languagesUpdateGet', ['id' => $item->id]) }}" class="bg-green-500 text-white px-2 py-2 rounded-lg sm:px-4 sm:py-2 sm:rounded-md mr-2 hover:bg-green-600 focus:outline-none focus:bg-green-600 inline-block">
                          ...
                          <a href="{{ route('languagesDelete', ['id' => $item->id]) }}" class="isdelete bg-red-500 text-white px-2 py-2 rounded-lg sm:px-4 sm:py-2 sm:rounded-md mr-2 hover:bg-red-600 focus:outline-none focus:bg-red-600 inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 block sm:hidden">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                            </svg>
                            <span class="hidden sm:inline-block">Sil</span>
                          </a>
                        </div>
                      </td>
                  </tr>
