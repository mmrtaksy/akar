            ...
            <div class="mx-auto max-w-[600px]">
                <div class="form-group mb-3">
                    ...
                    <div class="mt-2">
                        ...
                        <small>Sonradan değiştirilmez</small>
                    </div>
                </div>
                <div class="form-group mb-3">
                    <label for="value" class="block text-sm font-medium leading-6 text-gray-900">Durum*</label>
                    <div class="mt-2">
                        <textarea id="value" name="value" type="text" rows="6" required class="content px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ old('value') }}</textarea>
                    </div>
                </div>
                <div class="form-group mb-3">
                    <label for="description" class="block text-sm font-medium leading-6 text-gray-900">Açıklama</label>
                    <div class="mt-2">
                        <input id="description" name="description" type="text" value="{{ old('description') }}"  class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
